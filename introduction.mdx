...
2. Learn about the [behavioral signals and flags](signals) monitored by Roundtable.
3. Review the [API Reference](api-reference) to understand the request and response formats.

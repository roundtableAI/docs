...
The Roundtable badge is a small, drop-in widget that indicates whether Proof of Human is running on the page. Per our Terms of Service, you must include the badge on at least one page where tracking is active (see [Using the Roundtable Badge](/using-the-badge)).

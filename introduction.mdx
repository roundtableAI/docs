...
Roundtable is designed with privacy first. You decide whether to record visual session replays—simply turn the feature off if you only need behavioral signals. All data stays in‑tab for the life of the visit, and we never rely on cookies or long‑term browser storage.

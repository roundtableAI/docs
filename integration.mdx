...
Add the following lines of code to the end of your survey and set the `api_key` to your Alias API Key (you can generate keys on your [account](https://app.roundtable.ai/account)).
...
<Step title="Use it in an open-end component">

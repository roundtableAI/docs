...
The `low_effort_threshold` parameter accepts an integer value between 1 and 10, representing the minimum effort score required for a response to be considered acceptable. Responses below this threshold will be flagged with the "Automated test: Low-effort" check.

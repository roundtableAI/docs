...
Note: This changelog highlights the most notable changes in each version. For detailed information on the API request and response structures, please refer to the [API Reference](api-reference/v015).
...
### v0.21.0 - January 2025

#### New Features
- Introduced additional device fingerprinting checks to analyze browser characteristics
- Added fields to `fingerprint_checks` object in API response object

#### Improvements
- Significantly reduced worst-case latency
- Added automatic failover to secondary provider to handle OpenAI downtime

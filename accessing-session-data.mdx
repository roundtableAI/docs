...
This returns all data for the specified session, including automatically generated user logs and failed security checks. The session ID can be retrieved with `window.getRoundtableSessionId()` in the browser. 

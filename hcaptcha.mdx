...
This guide shows how to replace hCaptcha with Roundtable on form submissions. Unlike hCaptcha, which issues challenges at submission time, Roundtable runs completely invisibly in the background.

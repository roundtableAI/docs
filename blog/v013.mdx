...
We're excited to announce [Alias v013](../api-reference/v013) after great feedback from our customers. The major change has been decomposing the previous **Junk** flag to **Gibberish**, **Off-topic**, and **Low-effort**. We found **Junk** was too big of a catch-all, precisely because researchers have different exclusion criteria when it comes to tags like **Low-effort**. Now with this advanced junk detector, researchers can be extremely precise when automating their data cleaning process.

We ran v013 on our MTurk study below.
...
Sample answers from each flag are below. Question: What comes to your head when you think about Boston? Please give specific examples.
